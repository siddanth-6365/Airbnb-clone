  ...
  return (
    <>
      <header className=" flex justify-between">
        ...
        <div className="flex font-semibold p-3  divide-x border rounded-full shadow-md shadow-gray-300 cursor-pointer">
          <div className="p-2">Anywhere</div>
          <div className="p-2">Any week</div>
          <div className="p-2 text-gray-500">Add guests</div>
          <div className="p-2 ">
            <button>
              <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <Link
          ...
          className="flex h-12 gap-2 border border-gray-300 rounded-full p-3 cursor-pointer"
        >
          <div>
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          {/* !!user means if user exists then true will return and div will render or it will not render*/}
...
//check the export type and import accordingly
